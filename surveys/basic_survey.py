...
def show_page7_kmbi():
    ...
    **K-MBI 평가 안내**
    ...
    ⚠️ **보행**과 **의자차(휠체어)**는 둘 중 하나만 선택합니다.
    - 보행 가능한 경우: 보행 점수 적용 (만점 100점)
    - 의자차 사용하는 경우: 의자차 점수 적용 (만점 90점)
    """)
    ...
    **해석 기준** (백분율 기준)
    - 90% 이상: 독립 (일상생활 수행 가능)
    - 75-89%: 경도 의존 (약간의 도움 필요)
    - 60-74%: 중등도 의존 (상당한 도움 필요)
    - 40-59%: 중증 의존 (대부분의 활동에 도움 필요)
    - 40% 미만: 완전 의존 (거의 모든 활동에 도움 필요)
